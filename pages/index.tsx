...
export default function Home() {
  // let line = document.querySelector("path#word");
  ...
  return (
    <div className="">
      ...
      <Sidenav />
      <div className="flex h-screen justify-center bg-purple-200">
        <h1 className="mt-64 text-center text-5xl">Page 1</h1>
      </div>
      <div className="flex h-screen justify-center bg-orange-200">
        <h1 className="mt-64 text-center text-5xl">Page 2</h1>
      </div>
      <div className="flex h-screen justify-center bg-stone-700">
        <h1 className="mt-64 text-center text-5xl">Page 3</h1>
      </div>
